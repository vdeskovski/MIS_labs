...
import 'package:lab2/widgets/joke_type_list_widget.dart';
...
class _JokeTypeListScreenState extends State<JokeTypeListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("213159"), actions: [
        IconButton(onPressed: _getRandomJoke, icon: const Icon(Icons.adb))
      ]),
      body: Column(
        children: [
          const Text(
